  ...
  const doActivity = useCallback((activity: typeof activities[0]) => {
    ...
    setTimeout(() => {
      setGameStats(prev => {
        ...
        const newLevel = Math.floor(newRespect / 100) + 1;
    ...
    <Card className="p-6 bg-card/80 border-border backdrop-blur-xl shadow-2xl">
      <div className="space-y-6">
        <div className="text-center">
          ...
          <p className="text-sm text-muted-foreground">Зарабатывай деньги и прокачивай уровень!</p>
        </div>
        ...
        <div className="text-center text-xs text-muted-foreground">
          Достигни 10 уровня для разблокировки новых заданий!
        </div>
      </div>
    </Card>
  );
